 ...
 */
short_description?: string, interface?: SkillInterface, dependencies?: SkillDependencies, path: string, scope: SkillScope, allow_implicit_invocation: boolean, enabled: boolean, };
