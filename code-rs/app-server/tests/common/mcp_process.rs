...
use code_app_server_protocol::ClientNotification;
...
use code_app_server_protocol::ThreadRollbackParams;
...
use code_core::default_client::CODEX_INTERNAL_ORIGINATOR_OVERRIDE_ENV_VAR;
...
pub const DEFAULT_CLIENT_NAME: &str = "code-app-server-tests";
...
impl McpProcess {
    ...
    pub async fn new_with_env(
        ...
        let program = code_utils_cargo_bin::cargo_bin("code-app-server")
            .context("should find binary for code-app-server")?;
