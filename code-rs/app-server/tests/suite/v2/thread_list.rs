...
use chrono::DateTime;
use chrono::Utc;
use code_app_server_protocol::GitInfo as ApiGitInfo;
...
use code_app_server_protocol::SessionSource;
...
async fn list_threads_with_sort(
    ...
    let request_id = mcp
        .send_thread_list_request(code_app_server_protocol::ThreadListParams {
            cursor,
            limit,
            sort_key,
