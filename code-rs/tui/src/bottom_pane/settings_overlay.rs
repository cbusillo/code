...
impl SettingsSection {
    ...
    pub(crate) const fn help_line(self) -> &'static str {
        ...
        SettingsSection::Updates => "Control GitHub Release update checks and automatic upgrades.",
        ...
        SettingsSection::Memories => "Control whether future turns use cross-session memory guidance.",
